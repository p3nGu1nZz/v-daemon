...
3. Test on macOS/BSD (CI matrix) to validate ps_fallback and other fallbacks behave as expected.
4. Convert remaining ls-based loops to find -print0/xargs -0 for full NUL-safety where filenames may contain newlines.
